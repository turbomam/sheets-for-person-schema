...
# todo deleted compile-sheets dependency
# todo previously changed some person info schema's class URI form list item to scalar
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/sheets_for_person_schema/schema/*yaml src/*/datamodel/*py src/data src/docs tests
